...
## Quel avantages de R pour la Dares ? {.scrollable .smaller}
...
## Le travail en mémoire vive à la Dares {.scrollable .smaller}
...
## Connaitre le numéro de ligne {.scrollable .smaller}
...
L'article [Les pivots expliqués à ma fille](https://od-datamining.com/knwbase/pivots_r_fille/) est particulièrement bien fait sur le sujet.
